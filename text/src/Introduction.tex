...
%% However, not all combinations of features are
%% meaningful: features may have dependencies or interact.
%%
%% This would for example allow researchers to freely pick a subset of interesting
%% features when developing a new metatheoretic proof
%%
%% Not all compositions of features are meaningful: some features require the
%% presence or absence of other features. A car’s stereo system, for example,
%% requires an antenna. F
%%
%% Reuse through modularity. Languages that include common features like
%%   booleans and if expressions are found in many languages.
