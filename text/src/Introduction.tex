...
syntax and switch out the semantics and proof type-safety for the new semantics.
...
calculi feature either or both of these language constructs among many other.
...
semantics of language with variables often implement reduction of language
