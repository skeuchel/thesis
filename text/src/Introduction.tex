...
%% The common practice today is to specify and implement programming languages
%% in tandem.

%% Specification of programming languages are written after a

%% A language may be implemented and then specified, or specified and then
%% implemented, or these may develop together, which is usual practice today.

%% in tandem with implementations. Either by importing tested and practically
%% proven extensions from implementations (i.e. GHC) or by developing the
%% specification of
...
Type-checking Java programs is in general undecidable~\cite{grigore2017}.
