  ...
  \fbox{\begin{minipage}[t]{0.981391\columnwidth}
    \begin{tabular}{@@{\hspace{-7.5mm}}l@@{}l}
      \begin{minipage}[t]{0.5\linewidth}
        \hspace{7mm}\ruleline{Identity monad}
        \vspace{-12pt}
        \begin{spec}
          newtype Id a
        ...
        \hspace{7mm}\ruleline{State transformer}
        \vspace{-12pt}
        \begin{spec}
        ...
        \hspace{7mm}\ruleline{Reader transformer}
        \vspace{-12pt}
        \begin{spec}
    ...
    &
      \begin{minipage}[t]{0.5\linewidth}
        ...
        \hspace{7mm}\ruleline{Failure transformer}
        \vspace{-12pt}
        \begin{spec}
          newtype FailT m a
        ...
        \hspace{7mm}\ruleline{Exception transformer}
        \vspace{-12pt}
        \begin{spec}
          newtype ExcT x m a
