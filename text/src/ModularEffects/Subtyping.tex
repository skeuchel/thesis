...
\ensuremath{\Varid{f}}-algebras to Mendler-style algebras in a straightforward manner.
...
functors are composed with the same \ensuremath{\oplus} operator as in DTC.  The
composition operator for algebras is similar, but it combines Mendler
algebras instead of \ensuremath{\Varid{f}}-algebras.
